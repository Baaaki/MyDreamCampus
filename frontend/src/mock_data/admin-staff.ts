...
export const mockAdminStaffProfiles: Record<string, AdminStaffProfile> = {
  "admin-001": {
    ...
    position: "Fakülte Sekreteri",
    jobDescription:
      "Mühendislik Fakültesi idari işlerinin yönetimi ve koordinasyonu. Dekanlık ile bölümler arası iletişimin sağlanması, fakülte bütçe ve kaynak yönetiminin takibi.",
    responsibilities: [
  ...
  "admin-002": {
    ...
    position: "Öğrenci İşleri Şefi",
    jobDescription:
      "Mühendislik Fakültesi öğrenci işleri biriminin yönetimi. Öğrenci kayıt, kabul ve mezuniyet işlemlerinin koordinasyonu.",
    responsibilities: [
    ...
    officeLocation:
      "Mühendislik Fakültesi Öğrenci İşleri, Kat: Zemin, Oda: Z-05",
  ...
  "admin-003": {
    ...
    position: "Fakülte Sekreteri",
    jobDescription:
      "Fen Fakültesi genel idari işlerinin yönetimi. Akademik kadro ve bütçe planlaması, fakülte stratejik planlamasına katkı.",
    responsibilities: [
  ...
  "admin-004": {
    ...
    position: "Öğrenci İşleri Memuru",
    jobDescription:
      "Fen Fakültesi öğrenci işleri işlemlerinin yürütülmesi. Öğrenci belge ve evrak işlemlerinin takibi.",
    responsibilities: [
...
export const getAdminStaffProfileById = (
  id: string
