...
export default function AddCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const requestData: CreateCourseRequest = {
      ...
      course_type:
        formData.course_type === "Zorunlu" ? "mandatory" : "elective",
      ...
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Ders kataloğuna yeni bir ders ekleyin
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Dersin ait olduğu fakülte ve bölümü seçin
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="w-full">
                  <SelectValue
                    placeholder={
                      formData.faculty_id ? "Bölüm seçin" : "Önce fakülte seçin"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("class_level", parseInt(value))
                  }
                >
                  <SelectTrigger className="w-full">
                    <SelectValue />
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={formData.ects}
                  onChange={(e) =>
                    handleInputChange("ects", parseInt(e.target.value) || 0)
                  }
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("teaching_type", value)
                  }
                >
                  <SelectTrigger className="w-full">
                    <SelectValue />
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="İkinci Öğretim">
                      İkinci Öğretim
                    </SelectItem>
                    <SelectItem value="Uzaktan Öğretim">
                      Uzaktan Öğretim
                    </SelectItem>
                  </SelectContent>
                </Select>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Dersin koordinatör bilgilerini girin
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleCoordinatorChange("title", value)
                  }
                >
                  <SelectTrigger className="w-full">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Bu dersi başarıyla tamamlayan öğrenci neler yapabilecek?
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {formData.learning_outcomes.map((outcome, index) => (
              <div key={index} className="flex items-start gap-2">
                <span className="flex h-9 w-8 flex-shrink-0 items-center justify-center rounded bg-muted text-sm font-medium">
                  {index + 1}
                </span>
                <Input
              ...
              <div key={index} className="space-y-3 rounded-lg border p-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateWeeklyTopic(index, "description", e.target.value)
                    }
                    rows={2}
                  />
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Ders için önerilen kitap ve kaynaklar
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
