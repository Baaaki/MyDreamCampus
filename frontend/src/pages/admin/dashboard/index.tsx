          ...
          {quickLinks.map((link) => {
            ...
            return (
              <Link key={link.href} to={link.href} className="group block">
                <Card className="h-full transition-all hover:-translate-y-1 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900 dark:hover:border-gray-700">
                  <CardContent className="p-6">
                    <div
                      className={`inline-flex rounded-lg bg-gradient-to-br p-3 ${link.color} mb-4`}
                    >
                      <Icon className="h-6 w-6 text-white" />
                    </div>
        ...
        <Card className="dark:border-gray-800 dark:bg-gray-900">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                {
                  action: "Yeni öğrenci kaydı",
                  user: "Ahmet Yılmaz",
                  time: "5 dk önce",
                },
                {
                  action: "Ders programı güncellendi",
                  user: "Prof. Dr. Mehmet Demir",
                  time: "15 dk önce",
                },
                {
                  action: "Yoklama alındı",
                  user: "BIL 101",
                  time: "30 dk önce",
                },
                {
                  action: "Not girişi yapıldı",
                  user: "FIZ 102",
                  time: "1 saat önce",
                },
                {
                  action: "Yemek rezervasyonu",
                  user: "150 öğrenci",
                  time: "2 saat önce",
                },
              ].map((activity, index) => (
