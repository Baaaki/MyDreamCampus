...
const SemesterCoursesListPage = lazy(
  () => import("@/pages/admin/semester-courses/list")
)
const SemesterReviewPage = lazy(
  () => import("@/pages/admin/semester-courses/review")
)
...
const TeacherAttendanceCoursePage = lazy(
  () => import("@/pages/teacher/attendance/courseId")
)
const TeacherAttendanceSessionPage = lazy(
  () => import("@/pages/teacher/attendance/courseId/session/sessionId")
)
const TeacherEnrollmentPage = lazy(() => import("@/pages/teacher/enrollment"))
const TeacherGradesPage = lazy(() => import("@/pages/teacher/grades"))
const TeacherGradesCourseSlugPage = lazy(
  () => import("@/pages/teacher/grades/courseId/slug")
)
...
const StudentEnrollmentRejectionsPage = lazy(
  () => import("@/pages/student/enrollment/rejections")
)
const StudentGradesPage = lazy(() => import("@/pages/student/grades"))
const StudentCafeteriaPage = lazy(() => import("@/pages/student/cafeteria"))
const StudentCafeteriaMenuPage = lazy(
  () => import("@/pages/student/cafeteria/menu")
)
const StudentCafeteriaHistoryPage = lazy(
  () => import("@/pages/student/cafeteria/history")
)
