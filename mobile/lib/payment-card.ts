...
// Web ile ayni kurallar (frontend/src/lib/payment-card.ts); sunucu da ayni
// kontrolu yapar ve son sozu o soyler.
 ...
 */
export function validateCardForm(form: CardForm, now: Date = new Date()): CardFormErrors {
