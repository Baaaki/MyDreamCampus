...
WHERE ($1::text IS NULL OR faculty = $1)
  ...
  AND ($3::course_catalog.course_type_enum IS NULL OR course_type = $3)
  AND ($4::course_catalog.course_category_enum IS NULL OR course_category = $4)
  AND ($5::course_catalog.education_level_enum IS NULL OR education_level = $5)
  AND ($6::course_catalog.course_catalog_status_enum IS NULL OR status = $6)
