...
SELECT id, name, status, hard_deadline, activated_at, completed_at, created_at, updated_at FROM course_catalog.semesters WHERE status = 'active' LIMIT 1
`
...
SELECT id, name, status, hard_deadline, activated_at, completed_at, created_at, updated_at FROM course_catalog.semesters WHERE id = $1
`
...
SELECT id, name, status, hard_deadline, activated_at, completed_at, created_at, updated_at FROM course_catalog.semesters WHERE name = $1
`
...
SELECT id, name, status, hard_deadline, activated_at, completed_at, created_at, updated_at FROM course_catalog.semesters ORDER BY created_at DESC
`
