...
func (r *CompletedRepository) CreateCompletedCourse(ctx context.Context, arg db.CreateCompletedCourseParams) (db.GradesStudentCompletedCourse, error) {
...
func (r *CompletedRepository) GetCompletedCoursesByStudent(ctx context.Context, studentID uuid.UUID) ([]db.GradesStudentCompletedCourse, error) {
	return r.queries.GetCompletedCoursesByStudent(ctx, studentID)
}

func (r *CompletedRepository) GetCompletedCoursesByCourse(ctx context.Context, courseID uuid.UUID) ([]db.GradesStudentCompletedCourse, error) {
...
func (r *CompletedRepository) GetCompletedCourseByStudentAndCourse(ctx context.Context, studentID uuid.UUID, courseID uuid.UUID) (db.GradesStudentCompletedCourse, error) {
