...
//
// All cases freeze clock.Now at a chosen instant via clocktest, then
// assert the returned moment.
...
func TestGetNext3AM_BeforeThreeAM_SchedulesToday(t *testing.T) {
	...
	clocktest.Freeze(t, time.Date(2026, 5, 2, 2, 0, 0, 0, utcPlus3))
...
func TestGetNext3AM_AfterThreeAM_SchedulesTomorrow(t *testing.T) {
	...
	clocktest.Freeze(t, time.Date(2026, 5, 2, 4, 0, 0, 0, utcPlus3))
...
func TestGetNext3AM_LateNight_SchedulesTomorrow(t *testing.T) {
	...
	clocktest.Freeze(t, time.Date(2026, 5, 2, 23, 59, 0, 0, utcPlus3))
...
func TestGetNext3AM_ExactlyThreeAM_StaysToday(t *testing.T) {
	...
	clocktest.Freeze(t, time.Date(2026, 5, 2, 3, 0, 0, 0, utcPlus3))
...
func TestGetNext3AM_MonthRollover(t *testing.T) {
	...
	// month boundaries.
	clocktest.Freeze(t, time.Date(2026, 5, 31, 23, 0, 0, 0, utcPlus3))
...
func TestGetNext3AM_InputInUTC_StillReturnsUTCPlus3Zone(t *testing.T) {
	// Frozen at a UTC time — getNext3AM converts to UTC+3 internally.
	...
	clocktest.Freeze(t, time.Date(2026, 5, 2, 0, 0, 0, 0, time.UTC))
