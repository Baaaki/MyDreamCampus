...
const (
	StaffOutboxStatusEnumPending   OutboxStatusEnum = "pending"
	StaffOutboxStatusEnumProcessed OutboxStatusEnum = "processed"
	StaffOutboxStatusEnumFailed    OutboxStatusEnum = "failed"
)
...
type NullOutboxStatusEnum struct {
	OutboxStatusEnum OutboxStatusEnum `json:"staff_outbox_status_enum"`
